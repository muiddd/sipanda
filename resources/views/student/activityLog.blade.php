...
<head>
    ...
    <style>
        ...
        .heat-0 { background: rgba(117,203,80,0.06); }
        .heat-1 { background: rgba(117,203,80,0.20); }
        .heat-2 { background: rgba(117,203,80,0.40); }
        .heat-3 { background: rgba(117,203,80,0.65); }
        .heat-4 { background: #75cb50; }
